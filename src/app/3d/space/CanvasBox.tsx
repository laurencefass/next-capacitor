...
const CanvasBox: React.FC = () => {
  ...
  const { thrust, startThrust, stopThrust, toggleAutoThrust, isAutoThrust } =
    useThrust(handleThrust);
  ...
  return (
    <>
      <div className="banner">
        ...
        <p>
          Look around with mouse or drag, fly and rotate with WASD keys or
          buttons
        </p>
      </div>
      <Canvas
      ...
      >
        ...
        <Model
          ...
          rotation={rotation}
          position={position}
          url="/models/capsule.glb"
          scale={[0.05, 0.05, 0.05]}
        />
        <SpaceStation />
        <Asteroid />
        <Planet position={[0, -250, 0]}>
          <TexturedSphere args={[200, 32, 32]} url="/textures/earth.jpg" />
        </Planet>
        <Planet position={[0, 0, 1200]}>
          <TexturedSphere args={[200, 32, 32]} url="/textures/mars.jpg" />
        </Planet>
        <Planet position={[600, 0, -600]}>
          <TexturedSphere args={[200, 32, 32]} url="/textures/venus.jpg" />
        </Planet>
        <Planet position={[0, 1200, 0]}>
          <TexturedSphere args={[600, 32, 32]} url="/textures/jupiter.jpg" />
        </Planet>
        <Planet position={[0, 4800, 4800]}>
          <TexturedSphere args={[1200, 32, 32]} url="/textures/sun.jpg" />
        </Planet>
        {/* <Sun /> */}
        <Stars />
      </Canvas>
